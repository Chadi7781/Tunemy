...
function Footer() {
  return (
    <footer className="mx-auto  xl:px-20 lg:px-12 sm:px-6  w-full px-4 py-12 bg-sectionColor">
      <div className="flex flex-col items-center justify-center">
        <div>
          <h1 className='text-gray-800 dark:text-white hover:text-gray-500"'>
            Chadi Academy
          </h1>
        </div>
        ...
        <div className="flex items-center mt-6">
          <p className="text-base leading-4 text-gray-800 dark:text-gray-400">
            2021 <span className="font-semibold">Made by ChadiAcademy</span>
          </p>
